...
public class Tableau {
     ...
     * @return the bumped value, or null if the value was added to the end of the row.
     */
     ...
     * function.
     * 
     * @param f a function which when applied to a cell should return an integer.
     */
    ...
    protected static class Cell {
        ...
        /**
         * Returns how many horizontal and vertical (but not diagonal) neighbours this
         * cell has.
         * 
