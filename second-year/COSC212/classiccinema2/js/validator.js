...
var Validator = (function () {
    ...
    function validateCheckout() {
        let messages, cardType, cardNumber, cardMonth, cardYear, cardValidation;
        ...
        deliveryAddress = $("#deliveryAddress1").val();
        ...
        cardMonth = $("#cardMonth").val(); //do this
        ...
        if (messages.length === 0) {
            ...
            $("#checkoutForm").empty();
            $("#cartList").empty();
            $("#boomfa").append("<li>Thanks for purchasing!</li>")
        } else {
            $("#boomfa").empty();
            for (let i = 0; i < messages.length; i++){
                $("#boomfa").append("<li>- " + messages[i] + "</li>");
            }
            messages = [];
        }
