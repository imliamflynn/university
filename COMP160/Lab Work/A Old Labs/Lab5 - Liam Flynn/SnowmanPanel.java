...
public class SnowmanPanel extends JPanel{
  ...
  public void paintComponent (Graphics page){
    ...
    page.drawArc (MID - 10, TOP + 20, 20, 10, 0, 180);   // frown
    ...
    page.drawString ("Liam Flynn", 5, 15);
    
    page.setColor (Color.red);
    page.fillOval (MID-2, TOP + 50, 4, 4); //top button
    page.fillOval (MID-2, TOP + 60, 4, 4); //bottom button
  }
}
